...
- My biggest challenge was getting everything done in time.  I didn't have much trouble with the code (other than the physics part which took a LOT of head scratching).

- I would like to add the remainder of the levels to the game during summer break and if I have some time I might try and create my own sound for the game.
